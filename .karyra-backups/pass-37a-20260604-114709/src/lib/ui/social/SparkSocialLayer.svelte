...
<style>
  ...
  [data-theme='dark'] .social-event-card strong,
  [data-theme='dark'] .social-filter-card strong { color: #fff; }
  ...
  [data-theme='dark'] .social-event-card button { background: rgba(255,255,255,.055); }
  ...
  [data-theme='dark'] .social-filter-card button { background: rgba(255,255,255,.055); }
  ...
  [data-theme='dark'] .social-empty-state { background: rgba(255,255,255,.035); }

  .social-empty-state svg { color: var(--spark-blue-strong); }
  .social-empty-state strong { color: var(--spark-navy); }
  [data-theme='dark'] .social-empty-state strong { color: #fff; }
