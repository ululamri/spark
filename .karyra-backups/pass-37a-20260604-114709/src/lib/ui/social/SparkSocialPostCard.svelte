...
<style>
  ...
  [data-theme='dark'] .author-row strong { color: #fff; }
  ...
  [data-theme='dark'] .follow-btn { background: rgba(255,255,255,.055); }
  ...
  [data-theme='dark'] .post-body { color: #e5edff; }
  ...
  [data-theme='dark'] .post-tools button,
  [data-theme='dark'] .comment-compose button { background: rgba(255,255,255,.055); }
  ...
  [data-theme='dark'] .comment-thread { background: rgba(255,255,255,.04); }
  ...
  [data-theme='dark'] .comment-row strong { color: #fff; }
  ...
  [data-theme='dark'] .comment-compose input { background: rgba(255,255,255,.06); }
