<script lang="ts">
  ...
  function markWalletReady() {
    ...
    pushToast({
      title: 'Wallet readiness dicatat',
      copy: 'Koneksi wallet asli akan masuk melalui StarknetKit pada pass terpisah.',
      tone: 'info'
    });
  }
  ...
  function resetWalletReadiness() {
    ...
    pushToast({
      title: 'Wallet kembali opsional',
      copy: 'Pemula tetap bisa lanjut tanpa wallet.',
      tone: 'info'
    });
  }
</script>
