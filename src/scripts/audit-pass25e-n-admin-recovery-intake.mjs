...
assertIncludes('recovery server password action is separate', recoveryServer, 'recoverPassword');
assertNotIncludes('recovery server no unsafe reset alias', recoveryServer, 'reset_password');
assertIncludes('recovery server password endpoint is explicit', recoveryServer, "'/recovery/password'");
...
assertIncludes('recovery page boundary copy', recoveryPage, 'Recovery boundary');
assertIncludes('recovery page password field is gated', recoveryPage, "form?.artifact?.request_type === 'password'");
